...
execute if score McVersion fktool matches 116.. as @e[type=armor_stand,tag=fktool_biome,sort=nearest,limit=1] at @s run loot replace entity @s weapon.offhand loot fktool:biomes_1.16pre
